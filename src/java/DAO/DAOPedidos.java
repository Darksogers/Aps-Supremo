...
public class DAOPedidos {
    ...
    public JSONObject valorTotalPedido(Long codP){
        ...
        String sql="SELECT sum(ps.preco_total) as 'valor_total',ps.cod_pedido,us.nome_fantasia_nome_completo from tb_pedidos as ps,tb_usuario as us where ps.cpf_cnpj = us.cpf_cnpj and ps.cod_pedido ="+codP;
