   ...
   //Verifica o usuario no banco;
    ...
    public void criarUsuarioSGBD(String email, String pass){
       String sql="create user '"+email+"'@localhost identified by '"+pass+"' ";
                  ...
                  String sql4="GRANT select,insert,update ON DB_LANCHONETE.tb_lanches TO '"+email+"'@'localhost' WITH GRANT OPTION; ";
    ...
    public Boolean criarNovoUsuario(Usuario user,String senha){
        Boolean ok=null;
        ...
        try{
            ...
            if(this.verificaLogin(user.getEmail())==user.getCpf_cnpj()){
                ok=true;
